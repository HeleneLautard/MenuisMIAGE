...
public class SenderAffairePoseEffectuee implements MessageListener {
    ...
    String text = "Pose effectuée pour l'affaire N°XXX ";

    public SenderAffairePoseEffectuee() {
    }
    ...
    /**
     * Envoie de notification de pose effectuée
     */
    public void sendMsgPoseEffectuee() {
        try {
            ...
            message.setJMSType("PoseEffectuée");
            sender.send(message);
            System.out.println("Sent depuis GestionPose: " + message.getText());
